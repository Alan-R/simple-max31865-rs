...
/// Use a precision (1% or better) 100Ω resistor for accurate 0°C simulation.
#[cfg(any(target_arch = "arm", target_arch = "aarch64"))]
const RESISTOR_TOLERANCE: f64 = 0.05; // 5% tolerance for generic 100Ω resistor
#[cfg(any(target_arch = "arm", target_arch = "aarch64"))]
const NOMINAL_OHMS: f64 = 100.0;
#[cfg(any(target_arch = "arm", target_arch = "aarch64"))]
const MIN_OHMS: f64 = NOMINAL_OHMS * (1.0 - RESISTOR_TOLERANCE);
#[cfg(any(target_arch = "arm", target_arch = "aarch64"))]
const MAX_OHMS: f64 = NOMINAL_OHMS * (1.0 + RESISTOR_TOLERANCE);
...
#[cfg(any(target_arch = "arm", target_arch = "aarch64"))]
const MIN_TEMP_C: f64 = pt100_temperature_from_ohms(MIN_OHMS);
#[cfg(any(target_arch = "arm", target_arch = "aarch64"))]
const MAX_TEMP_C: f64 = pt100_temperature_from_ohms(MAX_OHMS);
...
fn test_env_pin_parsing() {
    ...
    env::set_var("MAX31865_CS_PIN", "23");
    ...
    env::remove_var("MAX31865_CS_PIN");
